...
<head>
  ...
  <title>Illegal Hub - Manage Products Panel</title>
  <?php
    include "header.php"; 
              ...
              <div class="row">
                <div class="row">
                  <div class="input-field white-text col s12">
                    ...
                    <textarea name="description" id="description" class="materialize-textarea white-text" minlength="200"></textarea>
              ...
              <div class="row">
                <div class="input-field white-text">
                  ...
                  <select name="category" id="category">
                    ...
                    <option value=0>Cradit Cards</option>
                    <option value=1>Gift Cards</option>
                    <option value=2>Flash BTC | USDT</option>
                  </select>
