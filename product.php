...
<head>
  ...
  ?>
  <title>Illegal Hub — <?php echo htmlspecialchars($name) ?></title>
</head>
<body>
...
<div class="container" style="margin-top: 10px;">
  <div class="rounded-card-parent" style="">
    <div class="card rounded-card" style="width:100%;height:100%">
      ...
      <form action="product.php" method="GET" style="padding-left: 10px;">
        ...
        <div class="" style="flex-wrap:wrap;width:100%;display:flex;">
          <div class="col s4 half-width full-width">   
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <?php   
                      ...
                      else echo(rand(5, 15) . " Ratings");
                    ?>
                    |
                    <?php
                      if ($item->checkSoldCount()){
                        echo($item->checkSoldCount() + rand(15, 25));
                        echo(" Sold");
                      }
                      else echo(rand(15, 25) . " Sold");
                    ?>
                    <!-- product details end -->
                  </tr>
